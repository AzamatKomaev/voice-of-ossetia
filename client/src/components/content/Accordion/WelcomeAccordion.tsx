...
const items = [
  <p>
    <b>Для чего нужен этот сайт?</b><br/> - Ответ прост: наша задача - обсуждение накипевших проблем и хранение жалоб
  </p>,
  <p>
    <b>Каких жалоб?</b><br/> - Жалобы могут быть различны: начиная от инфаструктуры вашего поселения и заканчивая
