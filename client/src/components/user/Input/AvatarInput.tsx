...
import {addFile} from "../../../utils/Actions/avatarLoad";
  ...
  return (
    <div>
      ...
      <p className="text-danger">
        На данный момент у нас отсутствует редактор изображений.
        Рекомендуем вам выбрать аватарку с одинаковой шириной и высотой
      </p>
